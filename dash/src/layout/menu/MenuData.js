const menu = [
  ...
  },
  {
    ...
    subMenu: [
      ...
      {
        text: "Add New Prospectus Requested",
        link: "/new-prospectus"
      },
    ]
  },
  {
    heading: "Arrange Visit Pages",
  },
  {
    icon: "building",
  ...
  //Remove this section when done with the main users
  {
    icon: "users",
    text: "User Manage",
    active: false,
