...
const ProspectusOverview = () => {
  return (
    <React.Fragment>
      <div className="card-title-group align-start">
        <CardTitle>
          <h6 className="title">Total no Prospectus</h6>
          <p>In last 30 days Prospectus Requested.</p>
        </CardTitle>
        <div className="card-tools">
          <TooltipComponent
            ...
            direction="left"
            id="tooltip-1"
            text="Total Prospectus Requested"
          />
        </div>
      </div>
...
export default ProspectusOverview;
