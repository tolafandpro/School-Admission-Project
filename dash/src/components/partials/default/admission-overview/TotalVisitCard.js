...
const ArrangeVistOverview = () => {
  return (
    <React.Fragment>
      <div className="card-title-group align-start">
        <CardTitle>
          <h6 className="title">Total no Requested Visit</h6>
          <p>In last 30 days Requested Visit.</p>
        </CardTitle>
        <div className="card-tools">
          <TooltipComponent
            ...
            direction="left"
            id="tooltip-1"
            text="Total number of Visit Requested"
          />
        </div>
      </div>
...
export default ArrangeVistOverview;
