...
import { OlashoreUserContextProvider } from "../context/OlaUserContext";
import { AdmissionContextProvider } from "../context/AdmissionContext";
...
// Olashores Pages
import UserList from "../pages/olashore-users/UserList"
...
import RegAdmission from "../pages/admission/RegAdmission";
import ProspectusSuccess from "../pages/Prospectus/ProspectusSuccess";
import ProspectusReg from "../pages/Prospectus/ProspectusReg";
  ...
  return (
      <Routes>
        <Route path={`${process.env.PUBLIC_URL}`} element={<Layout />}>
          ...
          <Route element={<OlashoreUserContextProvider/>} >
            <Route path="users" element={<UserList />}></Route>
            <Route path="user-new" element={<UserListCompact />}></Route>
            <Route path="user-details/:userId" element={<UserDetails />}></Route>
          </Route>
          
          <Route element={<AdmissionContextProvider />} >
            <Route path="admission-applications" element={<AdmissionForm />}></Route>
            <Route path="new-admission-application" element={<AdmissionForm />}></Route>
        ...
        <Route path={`${process.env.PUBLIC_URL}`} element={<LayoutNoSidebar />}>
          <Route path="new-admission" element={<RegAdmission />}></Route>
          <Route path="request-prospectus" element={<ProspectusReg />}></Route>
          <Route path="prospectus-success" element={<ProspectusSuccess />}></Route>
